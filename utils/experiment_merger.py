...
parser.add_argument(
    ...
    default=None,
    type=str,
    help="The comma separated list of the input experiments.",
    required=True,
)
parser.add_argument(
    "--out-exp",
    default=None,
    type=str,
    help="The output experiment folder.",
    required=True,
)
parser.add_argument(
    "--force-out", default=False, action="store_true", help="Force save final results."
)
