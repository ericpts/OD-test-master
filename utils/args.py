...
parser.add_argument(
    ...
    default=True,
    action="store_true",
    help="Disable visdom visualization. (default False)",
)
...
parser.add_argument(
    "--workers", type=int, default=4, help="Number of dataloader workers. (default 4)"
)
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="Save the output? (default False)",
)
parser.add_argument(
    "--no-cuda", default=False, action="store_true", help="Disable cuda?"
)
parser.add_argument(
    "--cuda-device", type=int, default=0, help="Select cuda device. (default 0)"
)
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="Whether should forcibly train H or just reuse.",
)
parser.add_argument(
    "--force-run",
    default=False,
    action="store_true",
    help="Force run the evaluation experiment?",
)
