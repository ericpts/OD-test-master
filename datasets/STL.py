...
class STL10(AbstractDomainInterface):
    ...
    def __init__(
        ...
        self.ds_train = datasets.STL10(
            root_path, split="train", transform=im_transformer, download=download
        )
        self.ds_test = datasets.STL10(
            root_path, split="test", transform=im_transformer, download=download
        )
