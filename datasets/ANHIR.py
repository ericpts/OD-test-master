...
class ANHIRBase(data.Dataset):
    def __init__(
        ...
        if extract:
            ...
            if not (
                osp.exists(osp.join(self.source_dir, "valid_split.pt"))
...
class ANHIR(AbstractDomainInterface):
    ...
    def __init__(
        self,
        root_path="./workspace/datasets/ANHIR",
        downsample=None,
