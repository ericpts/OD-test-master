...
if __name__ == "__main__":
    ...
    model = DRDDenseCustom(
        train_features=True, pretrained_weights_path="./model.pth.tar"
    )
    args.num_classes = 2
    CLSetup.train_classifier(
        args, model=model, dataset=dataset.get_D1_train(), balanced=True
    )
